...
def test_sender_allowlist_digits_e164_equivalence():
    assert adapter.is_sender_allowed("972545434384", "+972545434384", None) is True
    assert adapter.is_sender_allowed("+972545434384", "972545434384", None) is True
    assert adapter.is_sender_allowed("15550001111", "+972545434384", None) is False


def test_sender_allowlist_default_closed_and_allow_all():
    assert adapter.is_sender_allowed("972545434384", None, None) is False
    assert adapter.is_sender_allowed("972545434384", "", None) is False
    assert adapter.is_sender_allowed("972545434384", None, "true") is True
